...
export const ApiNamesData = [
  {
    name: 'JSON Formatter',
    description: 'Easily format, beautify, and validate',
    icon: 'fa fa-file-code',
    route: 'json-formatter'
  },
  {
    name: 'URL Shortener',
    description: 'Generate shorter URLs for long links to make sharing more convenient.',
    icon: 'fa fa-link',
    route: 'url-shortener'
  },
  {
    name: 'Regex Tester',
    description: 'Test and validate your regular expressions with real-time feedback.',
    icon: "fa-solid fa-slash",
    route: 'regex-tester'
  },
  {
    name: 'Password Generator',
    description: 'Create secure and random passwords of any length and complexity.',
    icon: 'fa fa-key',
  ...
  },
  {
    ...
    route: 'string-manipulation-tools'
  },
  {
    name: 'Base64 EncoderDecoder',
